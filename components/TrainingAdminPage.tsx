  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7] flex flex-col">
      ...
      <div className="bg-white border-b border-slate-100 px-6 py-4 flex items-center gap-4 shadow-sm">
        <button onClick={onBack} className="p-2 hover:bg-[#F7F7F7] rounded-xl transition-all">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4 shadow-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-[#F7F7F7] hover:bg-slate-200 text-slate-600 text-sm font-bold rounded-xl transition-all"
                  >
                    取消
                  </button>
                </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 mt-1.5" onClick={(e) => e.stopPropagation()}>
                        ...
                        <select 
                          ...
                          className="text-xs border border-slate-200 rounded px-1.5 py-0.5 text-slate-600 outline-none focus:border-emerald-400 bg-[#F7F7F7] hover:bg-white transition-colors cursor-pointer"
                        >
                           {versions.map(v => (
                             <option key={v.id} value={v.id}>
          ...
          <div className="max-w-2xl space-y-4">
            ...
            {accounts.length === 0 ? (
              ...
              <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
                <div className="grid grid-cols-3 bg-[#F7F7F7] px-5 py-2.5 text-xs font-bold text-slate-400">
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        <button onClick={() => setExpanded(e => !e)} className="shrink-0">
          {slide.image_base64 ? (
            ...
            <div className="w-16 h-10 rounded-lg bg-[#F7F7F7] flex items-center justify-center">
        ...
        <div className="flex items-center shrink-0 pr-3 rounded-lg overflow-hidden bg-[#F7F7F7] border border-slate-100 shadow-sm transition-all focus-within:border-emerald-300 focus-within:ring-2 focus-within:ring-emerald-50">
          <div className="bg-[#F7F7F7]/60 px-2 py-1.5 flex items-center gap-1 group/input">
