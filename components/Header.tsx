    ...
    <header className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100 print:hidden">
      <div className="px-4 h-11 flex items-center justify-between relative">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-sm font-bold text-slate-900 tracking-tight">StreamScript QA</h1>
          <span className="text-[9px] font-black bg-slate-100 text-slate-400 px-2 py-0.5 rounded-full uppercase tracking-widest ml-1">v2.8.5</span>
        </div>
        {actionSlot && (
          <div className="flex items-center gap-2">
            {actionSlot}
